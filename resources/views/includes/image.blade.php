            ...
            <div class="card-body">
                ...
                <div class="col-md-12">
                    ...
                    <p style="color:#949393; font-size: 14px;" class="float-right"> Creado el: {{$image->created_at}}</p>
                        <br>
                        <p style="color:#949393; font-size: 14px;" class="float-left"> Asignado a: {{$image->grupo}}</p>
                    </div>
                    <br><br>
                    <div class="col-md-12">
                        <a href="{{action('ImageController@show',['id' => $image->id_image])}}" class="btn btn-primary col-md-3 float-center">Comentarios ({{count($image->comments)}})</a>
                    </div>
                    <br>
                </div>
